...
export function CompressedRegion({
  ...
  if (side === "left") {
    return (
      <div className={styles.regionBlock}>
        <div className={`${styles.regionLabel} ${styles.regionLabelLeft}`}>
          {data.label}
        </div>
        <div className={styles.regionGrid}>
          ...
          <div className={styles.r32S16ColLeft}>
            {r32S16Content}
          </div>
  ...
  return (
    <div className={styles.regionBlock}>
      <div className={`${styles.regionLabel} ${styles.regionLabelRight}`}>
        {data.label}
      </div>
      <div className={styles.regionGrid}>
        ...
        <div className={styles.r32S16ColRight}>
          {r32S16Content}
        </div>
